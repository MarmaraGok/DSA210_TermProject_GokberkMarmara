...
The EDA stage examines both the raw variables and the transformed variables. The purpose is to understand the dataset before moving into formal tests and ML models.
